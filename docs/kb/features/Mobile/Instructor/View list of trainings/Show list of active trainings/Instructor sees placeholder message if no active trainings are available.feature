Feature: Instructor sees placeholder message if no active trainings are available

Scenario: Instructor sees placeholder message if no active trainings are available
